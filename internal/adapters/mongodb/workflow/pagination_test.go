...
func newTestWorkflow(t *testing.T) *model.Workflow {
	t.Helper()
...
func TestGetSortValue_CreatedAt(t *testing.T) {
	...
	result := getSortValue(w, "createdAt")
...
func TestGetSortValue_UpdatedAt(t *testing.T) {
	...
	result := getSortValue(w, "updatedAt")
...
func TestGetSortValue_Default(t *testing.T) {
	...
	result := getSortValue(w, "something_unknown")
